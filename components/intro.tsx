  ...
  return (
    ...
    >
      ...
      >
        ...
        I&apos;m a <b className="font-bold">Embedded Software Engineer</b> with{" "}
        <b className="font-bold">1+ years</b> of experience. Also I enjoy building{" "}
        <b className="italic">Web and Machine Learning Application</b>{" "}
      </motion.h1>
