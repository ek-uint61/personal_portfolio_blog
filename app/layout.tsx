...
export default function RootLayout({
  ...
  <div className="bg-[#c08b7882] dark:bg-[#a7b7bb] absolute top-[-1rem] -z-10 left-[-35rem] h-[50rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] sm:bg-[#c08b7875]" />
</div>  
